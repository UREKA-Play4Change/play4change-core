...
sealed interface HomeEvents : ComponentEvents {
    ...
    data class ContinueStruggle(val enrollmentId: String) : HomeEvents
    data class ContinueExplanation(val sessionId: String) : HomeEvents
    ...
    data object DismissRecoveryEmailBanner : HomeEvents
}
